...
\dothis{以下のコードをワークスペースで評価してください:}
\begin{code}{| w |}
w := Workspace new.
...
\dothis{それでは空文字列のところに\ct!'hello'!と入力してから、\emph{accept}してください。}
...
\st では、すべてがオブジェクトです。とくにクラスは、クラスのインスタンスの世界を旅するための、便利な機能を提供するオブジェクトです。%@?navigating through their instances: クラスのインスタンスの世界を旅するための?
