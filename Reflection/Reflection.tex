...
%@	"This message sets up a framework for the behavior of the class' subclasses.
	"このメッセージは問題のクラスの一連のサブクラスの振舞いについてのフレームワークを設定する。"
...
これまでのところ、\st のリフレクティブな機能は、おもに、オブジェクト、クラス、メソッド、そして実行時スタックにクエリを送ったり、これらをエクスプロアするのに用いてきました。ここからは、今までの\st システムの構造に関する知識をどのように使えば、メッセージをインターセプトして、その振舞いを実行時に変えることができるか、詳しく見ていきます。
