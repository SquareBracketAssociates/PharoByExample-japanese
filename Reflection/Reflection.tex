...
これらすべての機能は、\pharo のプログラミング環境、とくにコードブラウザ、に統合されています。
...
与えられた階層内のsuper送信をブラウズするには、たとえば、コレクションの階層内のsuper送信をブラウズするには、より洗練されたクエリを送ることができます:
\begin{code}{}
class := Collection.
...
関心のあるメソッドを識別するために、どのように、クラスからメソッド辞書へと、そしてメソッド辞書からコンパイル済みメソッドへと、どのようにナビゲートしているかに注意してください。%@?上のコードを完全には理解していない
