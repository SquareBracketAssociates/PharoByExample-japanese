...
ã‚³ãƒ¬ã‚¯ã‚·ãƒ§ãƒ³ã‚¯ãƒ©ã‚¹ç¾¤ã¯ \clsindmain{Collection} ã‚¯ãƒ©ã‚¹ã¨ \clsind{Stream} ã‚¯ãƒ©ã‚¹ã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹ã§ã€æ±ç”¨ç›®çš„ãªã‚‚ã®ã®ã‚°ãƒ«ãƒ¼ãƒ—ã§ã‚ã‚‹ã¨ã‚„ã‚„æ›–æ˜§ã«å®šç¾©ã—ã¦ãŠãã¾ã™ã€‚ã€Œ\ind{ãƒ–ãƒ«ãƒ¼ãƒ–ãƒƒã‚¯}ã€~\cite{Gold83a} ã«ç™»å ´ã™ã‚‹ã“ã®ã‚¯ãƒ©ã‚¹ã®ã‚°ãƒ«ãƒ¼ãƒ—ã«ã¯ \ct{Collection} ã® 17 å€‹ã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹ã¨  \ct{Stream} ã® 9 å€‹ã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹ã€åˆè¨ˆ 28 å€‹ã®ã‚¯ãƒ©ã‚¹ãŒå«ã¾ã‚Œã¦ã„ã¾ã™ã€‚ã“ã‚Œã‚‰ã¯ \st-80 ã‚·ã‚¹ãƒ†ãƒ ãŒãƒªãƒªãƒ¼ã‚¹ã•ã‚Œã‚‹å‰ã«ä½•åº¦ã‹å†è¨­è¨ˆã•ã‚ŒãŸã‚‚ã®ã§ã—ãŸã€‚ã“ã‚Œã‚‰ã®ã‚¯ãƒ©ã‚¹ç¾¤ã¯ã—ã°ã—ã°ã‚ªãƒ–ã‚¸ã‚§ã‚¯ãƒˆæŒ‡å‘è¨­è¨ˆã®ç³»çµ±çš„ãªä¾‹ã¨ã—ã¦è€ƒãˆã‚‰ã‚Œã¾ã™ã€‚
...
\pharo ã§ã¯ã€æŠ½è±¡ã‚¯ãƒ©ã‚¹ \ct{Collection} ã¯ 101 å€‹ã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹ã‚’ã€æŠ½è±¡ã‚¯ãƒ©ã‚¹ \ct{Stream} ã¯ 50 å€‹ã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹ã‚’æŒã¡ã¾ã™ãŒã€ã“ã‚Œã‚‰ã®ã†ã¡å¤šã (\mbox{\clsind{Bitmap}ã€}\mbox{\clsind{FileStream}ã€}\clsind{CompiledMethod} ãªã©) ã¯ã‚·ã‚¹ãƒ†ãƒ ã‚„ã‚¢ãƒ—ãƒªã‚±ãƒ¼ã‚·ãƒ§ãƒ³ã®ä¸€éƒ¨ã¨ã—ã¦ä½¿ã‚ã‚Œã‚‹ã‚ˆã†ã«ä½œã‚‰ã‚ŒãŸç‰¹åˆ¥ãªç›®çš„ã®ã‚‚ã®ãªã®ã§ã€ã‚·ã‚¹ãƒ†ãƒ æ§‹æˆã¨ã—ã¦ã€ŒCollectionã€ã¨ã—ã¦ã¯ã‚«ãƒ†ã‚´ãƒªãƒ¼åŒ–ã•ã‚Œã¾ã›ã‚“ã€‚ã“ã®ç« ã®ç›®çš„ã®ãŸã‚ã«ã€ã€Œã‚³ãƒ¬ã‚¯ã‚·ãƒ§ãƒ³éšå±¤ã€ã¨ã„ã†è¨€è‘‰ã¯ \ct{Collection} ã¨ã€ãã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹\emph{ã®ä¸­ã§} \scat{Collections-*} ã¨ã—ã¦ã‚«ãƒ†ã‚´ãƒ©ã‚¤ã‚ºã•ã‚ŒãŸã‚‚ã®ã‚’æŒ‡ã—ã¾ã™ã€‚
åŒæ§˜ã«ã€Œã‚¹ãƒˆãƒªãƒ¼ãƒ éšå±¤ã€ã¯ \ct{Stream} ã¨ã€ãã®ã‚µãƒ–ã‚¯ãƒ©ã‚¹\emph{ã®ä¸­ã§} \scat{Collections-Streams} ã¨ã—ã¦ã‚«ãƒ†ã‚´ãƒ©ã‚¤ã‚ºã•ã‚ŒãŸã‚‚ã®ã‚’æŒ‡ã—ã¾ã™ã€‚
ã“ã‚Œã‚‰ 56 å€‹ã®ã‚¯ãƒ©ã‚¹ã¯ 982 ã®ãƒ¡ãƒƒã‚»ãƒ¼ã‚¸ã«å¿œç­”ã§ãã€åˆè¨ˆ 1609 å€‹ã®ãƒ¡ã‚½ãƒƒãƒ‰ã‚’å®šç¾©ã—ã¦ã„ã‚‹ã®ã§ã™ï¼
...
ã“ã®ç« ã§ã¯ã‚³ãƒ¬ã‚¯ã‚·ãƒ§ãƒ³ã‚¯ãƒ©ã‚¹ã®ã†ã¡ \figref{CollClassesTree} ã«ç¤ºã™ä¸€éƒ¨ã‚’ä¸»ã«å–ã‚Šä¸Šã’ã¾ã™ã€‚
ã‚¹ãƒˆãƒªãƒ¼ãƒ ã«ã¤ã„ã¦ã¯ \charef{streams} ã§åˆ†ã‘ã¦è«–ã˜ã¾ã™ã€‚
...
\caption{¼ÂÁõµ»Ë¡¤Ë¤è¤ê¥«¥Æ¥´¥êÊ¬¤±¤·¤¿¥³¥ì¥¯¥·¥ç¥ó
    \figlabel{collsByImpl}}
% some of collections ¤À¤«¤é¡Ö°ìÉô¤Î¡×¤È¤¹¤Ù¤­¤Ê¤Î¤«¤â¤·¤ì¤Ê¤¤¤¬¡¢¤³¤³¤Ï´º¤¨¤ÆÌõ¤òÍî¤È¤¹¡£
\end{center}
\end{figure*}

µ¡Ç½¤Ë¤è¤ë¥«¥Æ¥´¥ê¡¼¤À¤±¹Í¤¨¤ì¤ĞÎÉ¤¤¤È¤¤¤¦¤ï¤±¤Ç¤Ï¤¢¤ê¤Ş¤»¤ó¡£¤É¤¦¤ä¤Ã¤Æ¥³¥ì¥¯¥·¥ç¥ó¥¯¥é¥¹¤¬¼ÂÁõ¤µ¤ì¤Æ¤¤¤ë¤«¤â¹Í¤¨¤Ê¤±¤ì¤Ğ¤Ê¤ê¤Ş¤»¤ó¡£\figref{collsByImpl} ¤Ë¼¨¤¹¤è¤¦¤Ë¡¢¼çÍ×¤Ê¼ÂÁõµ»Ë¡¤È¤·¤Æ¤Ï¸Ş¤Ä¤Î¤â¤Î¤¬¤¢¤ê¤Ş¤¹¡£

\begin{enumerate}
  \item Array ¤ÏÍ×ÁÇ¤ò¥³¥ì¥¯¥·¥ç¥ó¥ª¥Ö¥¸¥§¥¯¥È¼«¿È¤Î(¥¤¥ó¥Ç¥Ã¥¯¥¹»²¾È¤Ç¤­¤ë)¥¤¥ó¥¹¥¿¥ó¥¹ÊÑ¿ô¤Ë³ÊÇ¼¤·¤Ş¤¹¡£·ë²Ì¤È¤·¤Æ¡¢ÇÛÎó¤Ï¥µ¥¤¥º¸ÇÄê¤È¤Ê¤ê¡¢¤½¤ÎÂå¤ï¤ê¤Ë°ì²ó¤Î¥á¥â¥ê³ä¤êÅö¤Æ¤ÇÀ¸À®¤Ç¤­¤Ş¤¹¡£
  \clsindex{Array}
